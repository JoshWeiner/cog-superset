...
import { useDarkModeToggleMenuItem } from 'src/hooks/useDarkModeToggleMenuItem';
...
const RightMenu = ({
  ...
  // Quick single-click dark-mode toggle for the top navigation bar
  const darkModeToggleItem = useDarkModeToggleMenuItem({
    setThemeMode,
    themeMode,
  });
